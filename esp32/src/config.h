...
// Platzhalter — echtes Passwort kommt via build_flags (esp32/build.sh liest
// ~/.config/wlanhandregler/secrets.env). NIEMALS das echte Passwort hier
// eintragen, sonst landet es im Repo (public!).
